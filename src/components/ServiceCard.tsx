...
export function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <Link
      ...
      className="group relative flex h-full flex-col rounded-3xl border border-ink/8 bg-white p-7 transition-all hover:-translate-y-1 hover:border-brand/40 hover:shadow-xl"
    >
